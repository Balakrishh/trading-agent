...
class StrategyPlanner:
    ...
    TARGET_DTE = 45             # days-to-expiration target (increased for better options)
    ...
    def _plan_iron_condor(self, ticker: str, analysis: RegimeAnalysis,
        ...
        # Credit = sell premiums – buy premiums
        credit_put_side = sold_put["mid"] - bought_put["mid"]
        credit_call_side = sold_call["mid"] - bought_call["mid"]
    ...
    def _assemble_plan(self, ticker, name, analysis, expiration,
        ...
        net_credit = round(sold["mid"] - bought["mid"], 2)
