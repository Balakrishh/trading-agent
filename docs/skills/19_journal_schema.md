...
*Last verified against repo HEAD on 2026-06-03 (mode-tag auto-injection + dry_run_close action label split + run_mode="dryrun" separate journal file with CI isolation gate).*
