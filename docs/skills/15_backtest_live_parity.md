...
> **Source of truth:** [`trading_agent/backtest/__init__.py`](../../trading_agent/backtest/__init__.py); [`trading_agent/backtest/runner.py`](../../trading_agent/backtest/runner.py); [`trading_agent/backtest/cycle.py`](../../trading_agent/backtest/cycle.py); [`trading_agent/backtest/sim_position.py`](../../trading_agent/backtest/sim_position.py); [`trading_agent/backtest/account.py`](../../trading_agent/backtest/account.py); [`trading_agent/backtest/historical_port.py`](../../trading_agent/backtest/historical_port.py); [`trading_agent/backtest/synthetic_chain.py`](../../trading_agent/backtest/synthetic_chain.py); [`trading_agent/backtest/clock.py`](../../trading_agent/backtest/clock.py); [`trading_agent/backtest/black_scholes.py`](../../trading_agent/backtest/black_scholes.py); [`trading_agent/streamlit/backtest_ui.py`](../../trading_agent/streamlit/backtest_ui.py).
